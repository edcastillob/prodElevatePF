...
const Panel = ({ currentLanguage }) => {
  ...
  const renderView = () => {
    switch (view) {
      case "panel":
        return (
          <Dash toggleActive={toggleActive} currentLanguage={currentLanguage} />
        );
      case "users":
        return (
          <UsersAll
      ...
      <div>
        ...
        >
          <ul>
            ...
            >
              {t("dashboard.admin", { lng: currentLanguage })}
            </span>
            <li>
            ...
            <li>
              <a href="#" onClick={() => setView("category")}>
                ...
                <span className={styles.titles}>
                  {t("dashboard.categories", { lng: currentLanguage })}
                </span>
              </a>
            </li>
            ...
            <li>
              <a href="#" onClick={() => setView("providers")}>
                ...
                <span className={styles.titles}>
                  {t("dashboard.providers", { lng: currentLanguage })}
                </span>
              </a>
            </li>
            ...
            <li>
              <a href="#" onClick={() => setView("settings")}>
                ...
                <span className={styles.titles}>
                  {t("dashboard.settings", { lng: currentLanguage })}
                </span>
              </a>
            </li>
            <li>
