      ...
      {/* <div> */}
        ...
        <div className={styles.details}>
          ...
          <div className={styles.recentCustomers}>
            ...
            <table>
                <tr>
                  <td width='60px'><div className={styles.imgBx}><img src={logo}/></div></td>
                  <td><h4>Veralucia</h4><span>Peru</span></td>
                </tr>
                <tr>
                  <td width='60px'><div className={styles.imgBx}><img src={logo}/></div></td>
                  <td><h4>Leo</h4><span>Peru</span></td>
                </tr>
                <tr>
                  <td width='60px'><div className={styles.imgBx}><img src={logo}/></div></td>
                  <td><h4>Yhamira</h4><span>Peru</span></td>
                </tr>
                <tr>
                  <td width='60px'><div className={styles.imgBx}><img src={logo}/></div></td>
                  <td><h4>Cristian</h4><span>Peru</span></td>
                </tr>
              </table>
          </div>
        </div>
